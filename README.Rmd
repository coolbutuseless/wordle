...
The package captures code woich could be used to cheat at finding good candidate
words for Wordle.

`Wordle` is a word guessing puzzle [playable online](https://www.powerlanguage.co.uk/wordle/).

There's a small write-up in a recent [article in The Guardian](https://www.theguardian.com/games/2021/dec/23/what-is-wordle-the-new-viral-word-game-delighting-the-internet)
...
There's a lot of weird  words in the word list, so I picked out something a
