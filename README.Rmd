...
There's a small [article in The Guardian](https://www.theguardian.com/games/2021/dec/23/what-is-wordle-the-new-viral-word-game-delighting-the-internet) about it.
...
constraints revealed so far: `aside`  (which was the hidden target word).
...
The process of finding good candidate words given what letters have been seen
...
There's a lot of weird  words in the word list, so use a bit of common sense
to pick out a likely word - in this case: `eaten`
